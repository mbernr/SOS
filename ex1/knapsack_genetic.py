...
MU = NBR_ITEMS #numer of individuals to select for next generation
LAMBDA = NBR_ITEMS*2 #number of children to produce on each generation
CXPB = 0.7 #probability next generation is produced by crossover
MUTPB = 0.2 #probability next generation is produced by mutation
